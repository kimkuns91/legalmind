...
// import { IMessageContent, ITextContent, ServerMessage } from './ai/types';
...
//  * @returns 생성된 파일 URL
//  */
// async function generateDocumentFile(filledTemplate: FilledTemplate, documentType: string) {
//   try {
//     // PDF 문서 생성
